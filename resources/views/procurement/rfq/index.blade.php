...
@section('title', 'Procurement - RFQs')
...
<div class="sm:flex sm:items-center">
    ...
    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
        <a href="{{ route('procurement.rfq.create') }}" class="btn btn-primary">
            Create RFQ
        </a>
    </div>
</div>
...
<div class="mt-6 border-b border-gray-200">
    <nav class="-mb-px flex space-x-8" aria-label="Tabs">
        <a href="{{ route('procurement.indexRFQ') }}" class="border-primary-500 text-primary-600 whitespace-nowrap border-b-2 py-4 px-1 text-sm font-medium" aria-current="page">
            RFQs
        </a>
                ...
                <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        ...
                        <tr>
                            ...
                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                {{ $rfq->creator->name ?? 'N/A' }}
                            </td>
                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                {{ $rfq->submission_deadline ? $rfq->submission_deadline->format('M d, Y') : '-' }}
                            </td>
                            <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                <a href="{{ route('procurement.rfq.show', $rfq) }}" class="text-primary-600 hover:text-primary-900">View<span class="sr-only">, {{ $rfq->process_number }}</span></a>
                            </td>
                        </tr>
                        @empty
                        <tr>
