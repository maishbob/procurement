...
@section('title', 'Procurement - RFPs')
...
<div class="sm:flex sm:items-center">
    ...
    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
        <a href="{{ route('procurement.rfp.create') }}" class="btn btn-primary">
            Create RFP
        </a>
    </div>
</div>
...
<div class="mt-6 border-b border-gray-200">
    <nav class="-mb-px flex space-x-8" aria-label="Tabs">
        ...
        <a href="{{ route('procurement.indexRFP') }}" class="border-primary-500 text-primary-600 whitespace-nowrap border-b-2 py-4 px-1 text-sm font-medium" aria-current="page">
            RFPs
        </a>
