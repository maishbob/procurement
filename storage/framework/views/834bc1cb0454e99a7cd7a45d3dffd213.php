...
<?php $__env->startSection('title', 'Procurement - Bids'); ?>
...
<div class="mt-6 border-b border-gray-200">
    <nav class="-mb-px flex space-x-8" aria-label="Tabs">
        ...
        <a href="<?php echo e(route('procurement.indexBids')); ?>" class="border-primary-500 text-primary-600 whitespace-nowrap border-b-2 py-4 px-1 text-sm font-medium" aria-current="page">
            Bids
        </a>
    </nav>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\procurement\resources\views/procurement/bids/index.blade.php ENDPATH**/ ?>