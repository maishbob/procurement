...
<div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gradient-to-b from-primary-900 to-primary-800 px-6 pb-4 ring-1 ring-white/10">
    <!-- Logo -->
    <a href="<?php echo e(route('dashboard')); ?>" class="flex h-16 shrink-0 items-center hover:opacity-80 transition-opacity">
    ...
    <nav class="flex flex-1 flex-col">
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
                ...
                <ul role="list" class="-mx-2 space-y-1">
                    ...
                    <li>
                        <a href="<?php echo e(route('requisitions.index')); ?>" 
                           class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold <?php echo e(request()->routeIs('requisitions.*') ? 'bg-primary-700 text-white' : 'text-primary-200 hover:text-white hover:bg-primary-700'); ?>">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                            </svg>
                            Requisitions
                            <?php if(isset($pendingRequisitions) && $pendingRequisitions > 0): ?>
                                <span class="ml-auto w-6 h-6 rounded-full bg-red-500 text-white text-xs flex items-center justify-center"><?php echo e($pendingRequisitions); ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
                    <?php endif; ?>
                    ...
                    <!-- Procurement -->
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('procurement.view')): ?>
                    <li>
                        <a href="<?php echo e(route('procurement.index')); ?>" 
                           class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold <?php echo e(request()->routeIs('procurement.*') ? 'bg-primary-700 text-white' : 'text-primary-200 hover:text-white hover:bg-primary-700'); ?>">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="<?php echo e(route('purchase-orders.index')); ?>" 
                           class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold <?php echo e(request()->routeIs('purchase-orders.*') ? 'bg-primary-700 text-white' : 'text-primary-200 hover:text-white hover:bg-primary-700'); ?>">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="<?php echo e(route('grn.index')); ?>" 
                           class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold <?php echo e(request()->routeIs('grn.*') ? 'bg-primary-700 text-white' : 'text-primary-200 hover:text-white hover:bg-primary-700'); ?>">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="<?php echo e(route('suppliers.index')); ?>" 
                           class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold <?php echo e(request()->routeIs('suppliers.*') ? 'bg-primary-700 text-white' : 'text-primary-200 hover:text-white hover:bg-primary-700'); ?>">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <!-- Finance -->
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('finance.view')): ?>
                    <li x-data="{ open: <?php echo e(request()->routeIs('invoices.*', 'payments.*') ? 'true' : 'false'); ?> }">
                        ...
                        <ul x-show="open" x-cloak class="mt-1 px-2 space-y-1">
                            ...
                            <li>
                                <a href="#" 
                                   class="group flex gap-x-3 rounded-md p-2 pl-9 text-sm leading-6 font-semibold <?php echo e(request()->routeIs('wht-certificates.*') ? 'bg-primary-700 text-white' : 'text-primary-200 hover:text-white hover:bg-primary-700'); ?>">
                                    WHT Certificates
                                </a>
                            </li>
                        </ul>
                    ...
                    <li>
                        <a href="<?php echo e(route('reports.index')); ?>" 
                           class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold <?php echo e(request()->routeIs('reports.*') ? 'bg-primary-700 text-white' : 'text-primary-200 hover:text-white hover:bg-primary-700'); ?>">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <!-- Admin Section -->
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['admin.users', 'admin.roles', 'admin.settings'])): ?>
            <li>
                ...
                <ul role="list" class="-mx-2 mt-2 space-y-1">
                    ...
                    <li>
                        <a href="#" 
                           class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold <?php echo e(request()->routeIs('admin.users.*') ? 'bg-primary-700 text-white' : 'text-primary-200 hover:text-white hover:bg-primary-700'); ?>">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="#" 
                           class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold <?php echo e(request()->routeIs('admin.settings') ? 'bg-primary-700 text-white' : 'text-primary-200 hover:text-white hover:bg-primary-700'); ?>">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <li class="-mx-6 mt-auto">
                <div class="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-white border-t border-primary-700">
                    ...
                    <div class="flex-1">
                        <span class="block"><?php echo e(auth()->user()->full_name); ?></span>
