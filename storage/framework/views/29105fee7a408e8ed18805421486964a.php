...
<?php $__env->startSection('title', 'Receive Goods'); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8 md:flex md:items-center md:justify-between">
        ...
        <div class="mt-4 flex md:ml-4 md:mt-0">
            <a href="<?php echo e(route('grn.index')); ?>" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                Back to List
            </a>
        </div>
    </div>
    ...
    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
        <form action="<?php echo e(route('grn.store')); ?>" method="POST" class="p-6 md:p-8">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="mt-2">
                        <select id="purchase_order_id" name="purchase_order_id" required @change="updatePOItems()"
                            ...
                            <option value="<?php echo e($po->id); ?>" <?php echo e(old('purchase_order_id') == $po->id ? 'selected' : ''); ?>>
                                PO-<?php echo e($po->po_number); ?> (<?php echo e($po->supplier->name); ?>) - KES <?php echo e(number_format($po->total_amount, 2)); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-2">
                        <input type="date" id="grn_date" name="grn_date" value="<?php echo e(old('grn_date', date('Y-m-d'))); ?>" required
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6">
                        <?php $__errorArgs = ['grn_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="mt-2 text-sm text-red-600"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-span-full">
                    ...
                    <div class="mt-2">
                        <input type="text" id="receiving_location" name="receiving_location" value="<?php echo e(old('receiving_location')); ?>" required placeholder="e.g. Main Warehouse, Loading Bay 2"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6">
                        <?php $__errorArgs = ['receiving_location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="mt-2 text-sm text-red-600"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-span-full">
                    ...
                    <div class="mt-2">
                        <textarea id="remarks" name="remarks" rows="3"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6"><?php echo e(old('remarks')); ?></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="relative overflow-x-auto ring-1 ring-gray-900/5 sm:rounded-lg">
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody id="items-list" class="bg-white divide-y divide-gray-200">
                            ...
                            <?php if($poItems = old('items')): ?>
                                <?php $__currentLoopData = $poItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    <td class="px-6 py-4 font-medium text-gray-900">
                                        <?php echo e($item['description'] ?? 'Item'); ?>

                                    </td>
                                    <td class="px-6 py-4 text-right">
                                        <?php echo e($item['po_quantity'] ?? '-'); ?>

                                    </td>
                                    <td class="px-6 py-4">
                                        <input type="number" name="items[<?php echo e($index); ?>][quantity_received]" value="<?php echo e($item['received_quantity'] ?? ''); ?>" min="0" step="any" required
                                    ...
                                    <td class="px-6 py-4">
                                        <select name="items[<?php echo e($index); ?>][condition]" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6">
                                            <option value="good" <?php echo e(($item['condition'] ?? '') == 'good' ? 'selected' : ''); ?>>Good</option>
                                            <option value="damaged" <?php echo e(($item['condition'] ?? '') == 'damaged' ? 'selected' : ''); ?>>Damaged</option>
                                            <option value="expired" <?php echo e(($item['condition'] ?? '') == 'expired' ? 'selected' : ''); ?>>Expired</option>
                                        </select>
                                    </td>
                                    <td class="px-6 py-4 space-y-2">
                                        <input type="text" name="items[<?php echo e($index); ?>][serial_number]" value="<?php echo e($item['serial_number'] ?? ''); ?>" placeholder="Serial No."
                                        ...
                                        <input type="text" name="items[<?php echo e($index); ?>][batch_number]" value="<?php echo e($item['batch_number'] ?? ''); ?>" placeholder="Batch No."
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-xs sm:leading-6">
                                        <input type="date" name="items[<?php echo e($index); ?>][expiry_date]" value="<?php echo e($item['expiry_date'] ?? ''); ?>"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-xs sm:leading-6">
                                    </td>
                                    <td class="px-6 py-4">
                                        <input type="text" name="items[<?php echo e($index); ?>][storage_location]" value="<?php echo e($item['storage_location'] ?? ''); ?>" placeholder="Location"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6">
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="mt-8 flex items-center justify-end gap-x-6">
                <a href="<?php echo e(route('grn.index')); ?>" class="text-sm font-semibold leading-6 text-gray-900">Cancel</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\procurement\resources\views/grn/create.blade.php ENDPATH**/ ?>