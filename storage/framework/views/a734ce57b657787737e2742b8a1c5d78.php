...
<?php $__env->startSection('title', 'Procurement - Tenders'); ?>
...
<div class="sm:flex sm:items-center">
    ...
    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
        <a href="<?php echo e(route('procurement.tender.create')); ?>" class="btn btn-primary">
            Create Tender
        </a>
    </div>
</div>
...
<div class="mt-6 border-b border-gray-200">
    <nav class="-mb-px flex space-x-8" aria-label="Tabs">
        ...
        <a href="<?php echo e(route('procurement.indexTender')); ?>" class="border-primary-500 text-primary-600 whitespace-nowrap border-b-2 py-4 px-1 text-sm font-medium" aria-current="page">
            Tenders
        </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\procurement\resources\views/procurement/tender/index.blade.php ENDPATH**/ ?>