                    ...
                    <form class="space-y-6" action="<?php echo e(route('login')); ?>" method="POST">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <?php if(Route::has('password.request')): ?>
                                <div class="text-sm">
                                    <a href="<?php echo e(route('password.request')); ?>" class="font-semibold text-primary-600 hover:text-primary-500 transition-colors">
                                        Forgot password?
                                    </a>
                                </div>
                            <?php endif; ?>
...
<?php /**PATH C:\laragon\www\procurement\resources\views/auth/login.blade.php ENDPATH**/ ?>